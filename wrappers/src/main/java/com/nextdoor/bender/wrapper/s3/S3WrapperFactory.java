...
/**
 * Creates a {@link S3Wrapper}.
 */
public class S3WrapperFactory implements WrapperFactory {

  private S3WrapperConfig config;
  ...
  public void setConf(AbstractConfig<?> config) {
    this.config = (S3WrapperConfig) config;
  }

  @Override
  public Class<?> getChildClass() {
    return S3Wrapper.class;
  }
}
