...
public class SumoLogicTransportSerializer implements TransportSerializer {
  public SumoLogicTransportSerializer() {}

  @Override
  public byte[] serialize(InternalEvent ievent) {
    /*
     * Create a JSON line that describes the record for SumoLogic.
     */
