...
public class GenericTransportBuffer implements TransportBuffer {
  private static final Logger logger = Logger.getLogger(GenericTransportBuffer.class);
  ...
  public GenericTransportBuffer(long maxBatchSize, boolean useCompression,
      TransportSerializer serializer) throws IOException {
