...
@JsonSchemaDescription("Writes events to a Datadog endpoint.")
public class DatadogTransportConfig extends TcpTransportConfig {
  ...
  public Class<?> getFactoryClass() {
    return DatadogTransportFactory.class;
  }
