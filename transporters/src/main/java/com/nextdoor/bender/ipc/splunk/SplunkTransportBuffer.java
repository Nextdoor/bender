...
public class SplunkTransportBuffer implements TransportBuffer {
  private static final Logger logger = Logger.getLogger(SplunkTransportBuffer.class);
  private final ByteArrayOutputStream baos = new ByteArrayOutputStream();
  private final OutputStream os;
  private final long maxBatchSize;
  private final SplunkTransportSerializer serializer;
  private long batchSize = 0;

  public SplunkTransportBuffer(long maxBatchSize, boolean useCompression,
      SplunkTransportSerializer serializer) throws IOException {
