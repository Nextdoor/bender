...
public class ScalyrTransportBufferTest {
  ...
  public void testAdd() throws IOException {
    ...
    ScalyrTransportBuffer buffer = new ScalyrTransportBuffer(1, false, serializer);
  ...
  public void testGzip() throws IOException {
    ScalyrTransportSerializer serializer = mock(ScalyrTransportSerializer.class);
    doReturn("foo".getBytes()).when(serializer).serialize(any(InternalEvent.class));
    ScalyrTransportBuffer buffer = new ScalyrTransportBuffer(1, true, serializer);
