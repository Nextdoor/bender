...
public class SplunkTransportBufferTest {

  @Test
  public void testAdd() throws IOException {
    SplunkTransportSerializer serializer = mock(SplunkTransportSerializer.class);
    doReturn("foo".getBytes()).when(serializer).serialize(any(InternalEvent.class));
    SplunkTransportBuffer buffer = new SplunkTransportBuffer(1, false, serializer);
  ...
  public void testGzip() throws IOException {
    SplunkTransportSerializer serializer = mock(SplunkTransportSerializer.class);
    doReturn("foo".getBytes()).when(serializer).serialize(any(InternalEvent.class));
    SplunkTransportBuffer buffer = new SplunkTransportBuffer(1, true, serializer);
