...
public class SumoLogicTransportBufferTest {

  @Test
  public void testAdd() throws IOException {
    SumoLogicTransportSerializer serializer = mock(SumoLogicTransportSerializer.class);
    doReturn("foo".getBytes()).when(serializer).serialize(any(InternalEvent.class));
    SumoLogicTransportBuffer buffer = new SumoLogicTransportBuffer(1, false, serializer);
  ...
  public void testGzip() throws IOException {
    SumoLogicTransportSerializer serializer = mock(SumoLogicTransportSerializer.class);
    doReturn("foo".getBytes()).when(serializer).serialize(any(InternalEvent.class));
    SumoLogicTransportBuffer buffer = new SumoLogicTransportBuffer(1, true, serializer);
