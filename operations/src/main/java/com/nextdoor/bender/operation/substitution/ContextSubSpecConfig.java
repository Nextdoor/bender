...
public class ContextSubSpecConfig extends SubSpecConfig<ContextSubSpecConfig> {
  ...
  @JsonSchemaDescription("List of context fields to add. If non-specified then all are added.")
  @JsonProperty(required = false)
  @JsonSchemaDefault(value = "{}")
  private List<String> includes = Collections.emptyList();

  @JsonSchemaDescription("List of context fields to exclude. If non-specified then none are excluded.")
  @JsonProperty(required = false)
  @JsonSchemaDefault(value = "{}")
